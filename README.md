<div align="center">
  <h1>🇨🇳 Awesome Chinese Repos</h1>
  <p><i>Outstanding open-source projects from China's developer community,<br>translated and organized for the international audience.</i></p>
  <p>
  ...
  <p>
    ...
    <a href="#-full-stack-systems--admin-panels">Enterprise Systems</a> &bull;
    <a href="#-developer-tools--libraries">Dev Tools</a> &bull;
    <a href="#-wechat-ecosystem">WeChat</a> &bull;
...
## Why Chinese Open Source?

China's open-source ecosystem serves **1.4 billion users** and produces software at a scale few other communities match. These projects are battle-tested:

- **Alibaba** open-sourced the tools behind Double 11 — the world's largest shopping event ($84B+ in a single day)
- **Baidu**, **Tencent**, and **ByteDance** release AI models trained on massive Chinese-language corpora
- **DeepSeek**, **Zhipu AI**, and **01.AI** push the frontier of open-weight LLMs
- **PingCAP** and **Zilliz** build globally-adopted database technology (TiDB, Milvus)
- The **WeChat ecosystem** (1.3B+ users) created development paradigms that don't exist elsewhere

Yet many of these projects remain invisible to international developers because their documentation is in Chinese. **This list bridges that gap.**

> Projects marked with `EN` have English READMEs. All others default to Chinese — but every entry below includes an English description.
...
## 🏗️ Full-Stack Systems & Admin Panels

_Production-grade enterprise systems demonstrating full-stack architecture patterns at China scale. Many serve as both learning resources and production templates._

_Related: [Backend Frameworks & Middleware](#-backend-frameworks--middleware), [WeChat Ecosystem](#-wechat-ecosystem)_
...
## 🌐 Backend Frameworks & Middleware

_Networking tools, API frameworks, and infrastructure middleware._
...
_Android components and mobile development tools._
...
_China's WeChat platform (1.3B+ users) has a unique developer ecosystem with Mini Programs, Official Accounts, and payment integrations that don't exist anywhere else._
...
_Places to discover more Chinese open-source projects._

- [HelloGitHub](https://hellogithub.com/) - Monthly Chinese open-source project discovery platform with English translations
- [Gitee Featured](https://gitee.com/explore) - China's largest Git hosting platform (Gitee) featured projects
- [OSC Open Source Awards](https://www.oschina.net/project/top_cn) - Annual Chinese open-source project awards by OSChina

## Contributing

Your contributions are always welcome! Please read [CONTRIBUTING.md](CONTRIBUTING.md) before submitting a pull request.

## Star History

<div align="center">
  <a href="https://star-history.com/#spectramaster/Awesome-Chinese-Repos&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=spectramaster/Awesome-Chinese-Repos&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=spectramaster/Awesome-Chinese-Repos&type=Date" />
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=spectramaster/Awesome-Chinese-Repos&type=Date" width="600" />
    </picture>
  </a>
</div>
